...
class ChatPageState extends State<ChatPage> {
                ...
                itemBuilder: (context, message) {
                  ...
                  return VisibilityDetector(
                      ...
                      onVisibilityChanged: (visibilityInfo) {
                        ...
                        String keyString = visibilityInfo.key
                            .toString(); // Convert the Key to a string
                        int? intValue = int.tryParse(
                            keyString.replaceAll(RegExp(r'\D'), ''));
  ...
  Future<void> _sendMessagePostBack(
      BuildContext context, String postBackMessage) async {
    var qiscus = context.read<QiscusUtil>();
